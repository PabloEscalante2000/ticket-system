...
alter table "public"."tenant_permissions" add constraint "tenant_permissions_tenant_fkey" FOREIGN KEY (tenant) REFERENCES public.tenants(id) not valid;
...
grant delete on table "public"."service_users" to "postgres";

grant insert on table "public"."service_users" to "postgres";

grant references on table "public"."service_users" to "postgres";

grant select on table "public"."service_users" to "postgres";

grant trigger on table "public"."service_users" to "postgres";

grant truncate on table "public"."service_users" to "postgres";

grant update on table "public"."service_users" to "postgres";
...
grant delete on table "public"."tenant_permissions" to "postgres";

grant insert on table "public"."tenant_permissions" to "postgres";

grant references on table "public"."tenant_permissions" to "postgres";

grant select on table "public"."tenant_permissions" to "postgres";

grant trigger on table "public"."tenant_permissions" to "postgres";

grant truncate on table "public"."tenant_permissions" to "postgres";

grant update on table "public"."tenant_permissions" to "postgres";
